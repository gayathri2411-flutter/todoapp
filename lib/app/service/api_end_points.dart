...
class ApiEndPoints {
  ...
  static const String INDIA_FORGOT_SMS =
      "/mobileVerification/app/phoneNumber/v1/twillo/forgotPassword/sms";
  static const String FORGET_PASSWORD_REQ_OTP =
      "/mobileVerification/app/phoneNumber/v1/twillo/sms";
  ...
  static const String BOOKING_API =
      "/notification/tripId/all/user/back/todevice";
  static const String COUPON_BOOKING_API =
      "/notification/v1/tripId/all/user/back/todevice";

  static const String ENDPOINT_CHECK_WALLET_BALANCE =
      "/wallet/app/v1/find/{userId}";
  static const String ENDPOINT_CHECK_WALLET_ADD = "/wallet/app/v1/add";
  static const String ENDPOINT_CHECK_WALLET_TOKENCHECK =
      "/wallet/app/v1/find/token/{token}";

  static const String ENDPOINT_SERVER_ForgetPassword =
      "/app/user/v1/forgotpassword/retrieve/{email}";
  static const String ENDPOINT_SERVER_TaxiDetails =
      "/taxi/app/taxi/v1/details/{taxiId}";
  static const String ENDPOINT_SERVER_UserDetails =
      "/logout/app/userDetail/v1/";
  static const String ENDPOINT_SERVER_CheckUserImage =
      "/logout/app/userDetail/v2/";
  static const String ENDPOINT_SERVER_VehicleInfo =
      "/vehicleType/app/taxi/v1/type/updateInfo";
  static const String ENDPOINT_SERVER_ProfileUpdate =
      "/logout/app/user/v2/update";
  static const String ENDPOINT_SERVER_ProfileImage = "/driver-photo";
  static const String ENDPOINT_SERVER_LOGIN =
      "/userLogin/app/user/v1/mobile/user/login";
  ...
  static const String ENDPOINT_STATUS_UPDATE =
      "/search/app/taxi/v1/status/{taxiId}/{userId}/{latitude}/{longitude}/{driverStatus}";
  static const String ENDPOINT_DRIVERBILL_TOTAL_AMOUNT =
      "/app/driverBilling/v1/{supplierId}/{driverId}";
  ...
  static const String ENDPOINT_LOGOUT =
      "/logout/app/admin/user/v1/loginStatus";
  static const String ENDPOINT_STATUS_UPDATE_LANGUAGE =
      "/app/user/v1/language/update/{userId}/{language}";
  static const String ENDPOINT_OTP_REQ =
      "/mobileVerification/app/phoneNumber/v1/twillo/new/sms";
  static const String ENDPOINT_RIDE_OTP_SMS_TO_USER =
      "/mobileVerification/app/phoneNumber/v1/twillo/ride/verification/sms";
  static const String ENDPOINT_VALIDATE_OTP_REQ =
      "/mobileVerification/app/user/twillo/v1/token";
  static const String ENDPOINT_VALIDATE_RIDE_OTP_REQ =
  ...
  static const String ENDPOINT_TRIP_HISTORY = "https://india.taxideals.online/ride/app/v1/user/get/664dde705b782a01853e90e4";
  ...
  static const String ENDPOINT_SIGNUP_REQ =
      "/userLogin/app/user/v1/mobile/full/registration";
  static const String ENDPOINT_FCM_TOKEN = "/user/v1/find/id/token";
  static const String ENDPOINT_UPDATE_PRICE_KM =
      "/ride/app/v1/rideUpdateFinished/gps/";
